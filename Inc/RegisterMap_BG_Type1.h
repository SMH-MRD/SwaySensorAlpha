///////////////////////////////////////////////////////////////////////////////
// file    : RegisterMap_BG_Type1.h
// brief   : Register map of BG series Type 1
// version : 1.0.1.0
...
/////////////////////////////////////////////////////////
//
// Register Map for BG series Type 1 
//
// For
//  B/W:   BG030, BG031, BG080, BG130, BG202,
//  Color: BG030C, BG030CF, BG130C, BG130CF
//
/////////////////////////////////////////////////////////

#ifndef _REGISTERMAP_BG_TYPE1_H
#define _REGISTERMAP_BG_TYPE1_H


namespace Teli {
    namespace RegMapBGType1 {
    
        //================================================================
        // Register map of BG series Type 1
        //  
        ...
        enum _REG_ADR_BG
        {
            ...
            ADR_DEV_SFNCVERSION_MAJOR_I     = 0x0000A200,           // RO   Major version of Standard Feature Name Convention.          #Appended V1.0.1.0
            ADR_DEV_SFNCVERSION_MINOR_I     = 0x0000A204,           // RO   Minor version of Standard Feature Name Convention.          #Appended V1.0.1.0
            ADR_DEV_SFNCVERSION_SUB_I       = 0x0000A208,           // RO   Sub Minor version of Standard Feature Name Convention.      #Appended V1.0.1.0
            ...
            //ADR_DECIMATION_H_I                = 0x0,                  //          Horizontal decimation.                          Not implemented in current BG Series.   # Replaced V1.0.1.0
            //ADR_DECIMATION_V_I                = 0x0,                  //          Vertical decimation.                            Not implemented in current BG Series.   # Replaced V1.0.1.0
            ADR_DECIMATION_H_I              = 0x0000A89C,           // RW,(RO)  Horizontal decimation.                              # Replaced V1.0.1.0.    
            ADR_DECIMATION_V_I              = 0x0000A8B0,           // RW,(RO)  Vertical decimation.                                # Replaced V1.0.1.0.
            ADR_REVERSE_X_I                 = 0x0,                  // RW,(RO)  Horizontal reverse (mirror).                    Not implemented in current BG Series.
            ADR_REVERSE_Y_I                 = 0x0,                  // RW,(RO)  Vertical reverse (mirror).                      Not implemented in current BG Series.
            ADR_PIXEL_FORMAT_E              = 0x0000A8D4,           // RW,(RO)  Pixel format. [g_saVAL_PixFmt]
            ADR_PIXEL_SIZE_E                = 0x0000A8E4,           // RW,(RO)  Pixel size. [g_saVAL_PixSizeBG]                     # Appended V1.0.1.0.
            ...
            //ADR_ACQ_FRAME_COUNT_I         = 0x0,                  //          Frame count for "MultiFrame" acqusition mode.   Not implemented in current BG Series.   # Deleted V1.0.1.0.
            //ADR_ACQ_FRAME_COUNT_MIN_I     = 0x0,                  //          Minimum value of frame count register.          Not implemented in current BG Series.   # Deleted V1.0.1.0.
            //ADR_ACQ_FRAME_COUNT_MAX_I     = 0x0,                  //          Maximum value of frame count register.          Not ot implemented in current BG Series.    # Deleted V1.0.1.0.
            //ADR_ACQ_FRAME_COUNT_INC_I     = 0x0,                  //          Increment　value of frame count register.       Not ot implemented in current BG Series.    # Deleted V1.0.1.0.
            ...
            ADR_TRIGGER_MODE_E              = 0x0000B098,           // RW,(RO)  Trigger mode. [g_saVAL_OnOff]                   Restricted by TLParamsLocked.
            ADR_TRIGGER_SOFTWARE_C          = 0x0000B0A0,           // WO       Trigger command for software trigger mode.      1: Execution.
            ADR_TRIGGER_SOURCE_E            = 0x0000B0A8,           // RW,(WO)  Trigger source. [g_saVAL_TrgSrc]                Restricted by TLParamsLocked. Value definition is differenct from USB3 Vision.

            ADR_TRIGGER_ACTIVATION_E        = 0x0000B0B0,           // RW,(WO)  Activation mode of Trigger. [g_saVAL_TrgAct]    Restricted by TLParamsLocked
            //ADR_TRIGGER_OVERLAP_E         = 0x0,                  //          Trigger overlap mode. [g_saVAL_TrgOvl]          Not implemented in current BG Series.       #Deleted V1.0.1.0.
            ADR_TRIGGER_DELAY_F             = 0x0000B0C0,           // RW,(RO)  Trigger delay in microseconds. 0 to 4095 microseconds. Minum and maximum value is not stored in register.
            ADR_TRIGGER_SAMPLING_F          = 0x0000B200,           // RW,(RO)  Trigger sampling period in microseconds. 
            ...
            ADR_EVNT_NTFY_FRM_TRG_ERROR_E   = 0x0000C830,           // RW       On/Off of Frame trigger error event. [g_saVAL_OnOff]                # Appended V1.0.1.0
            ADR_EVNT_NTFY_FRM_TRG_WAIT_E    = 0x0000C834,           // RW       On/Off of Frame trigger wait event. [g_saVAL_OnOff]                 # Appended V1.0.1.0
            ...
            ADR_TIMER_TRG_ACTIVATION_E      = 0x0000C018,           // RW       Trigger activation of timer. [g_saVAL_TrgAct]       Restricted by TLParamsLocked    # Appended V1.0.1.0.
            ...
            ADR_BLOCK_START_DELAY_I         = 0x0000e204,           // RW       Block Start delay.                          # Appended V1.0.1.0
            ADR_BLOCK_START_DELAY_MAX_I     = 0x0000e210,           // RW       Block Start delay maximum value.            # Appended V1.0.1.0
    ...
    #define LEN_COLOR_CORRECTION_MATRIX_J   (0x04)                  // Length of a ColorCorrectionMatrix register.
        ...
        const REGDATA g_sREGV_CCP_None      = REGDATA( RV_CCP_OPEN_ACCESS,  (char*)"OpenAccess");
        const REGDATA g_sREGV_CCP_Exclusive = REGDATA( RV_CCP_EXCLUSIVE,    (char*)"ExclusiveAccess");
        const REGDATA g_sREGV_CCP_Control   = REGDATA( RV_CCP_CONTROL,      (char*)"ControlAccess");
        const REGDATA g_sREGV_CCP_SwOver    = REGDATA( RV_CCP_CONTROL + RV_CCP_CONTROL_SW,  (char*)"ControlAccessSwitchoverActive");
        ...
        const REGDATA g_sREGV_PixFmt_Mono8      = REGDATA(PXL_FMT_Mono8,        (char*)"Mono8");
        const REGDATA g_sREGV_PixFmt_Mono10     = REGDATA(PXL_FMT_Mono10,       (char*)"Mono10");
        const REGDATA g_sREGV_PixFmt_BayerGR8   = REGDATA(PXL_FMT_BayerGR8,     (char*)"BayerGR8");
        const REGDATA g_sREGV_PixFmt_BayerGR10  = REGDATA(PXL_FMT_BayerGR10,    (char*)"BayerGR10");
        const REGDATA g_sREGV_PixFmt_BayerGR12  = REGDATA(PXL_FMT_BayerGR12,    (char*)"BayerGR12");
        const REGDATA g_sREGV_PixFmt_BayerRG8   = REGDATA(PXL_FMT_BayerRG8,     (char*)"BayerRG8");
        const REGDATA g_sREGV_PixFmt_BayerRG10  = REGDATA(PXL_FMT_BayerRG10,    (char*)"BayerRG10");
        const REGDATA g_sREGV_PixFmt_BayerRG12  = REGDATA(PXL_FMT_BayerRG12,    (char*)"BayerRG12");
        const REGDATA g_sREGV_PixFmt_BayerGB8   = REGDATA(PXL_FMT_BayerGB8,     (char*)"BayerGB8");
        const REGDATA g_sREGV_PixFmt_BayerGB10  = REGDATA(PXL_FMT_BayerGB10,    (char*)"BayerGB10");
        const REGDATA g_sREGV_PixFmt_BayerGB12  = REGDATA(PXL_FMT_BayerGB12,    (char*)"BayerGB12");
        const REGDATA g_sREGV_PixFmt_BayerBG8   = REGDATA(PXL_FMT_BayerBG8,     (char*)"BayerBG8");
        const REGDATA g_sREGV_PixFmt_BayerBG10  = REGDATA(PXL_FMT_BayerBG10,    (char*)"BayerBG10");
        const REGDATA g_sREGV_PixFmt_BayerBG12  = REGDATA(PXL_FMT_BayerBG12,    (char*)"BayerBG12");
        const REGDATA g_sREGV_PixFmt_RGB8       = REGDATA(PXL_FMT_RGB8,         (char*)"RGB8");
    //  const REGDATA g_sREGV_PixFmt_RGB8       = REGDATA(PXL_FMT_RGB8,         (char*)"RGB8Packed");       // GD
        const REGDATA g_sREGV_PixFmt_BGR8       = REGDATA(PXL_FMT_BGR8,         (char*)"BGR8");
    //  const REGDATA g_sREGV_PixFmt_BGR8       = REGDATA(PXL_FMT_BGR8,         (char*)"BGR8Packed");       // GD
        const REGDATA g_sREGV_PixFmt_YUV411P    = REGDATA(PXL_FMT_YUV411_8,     (char*)"YUV411Packed");
        const REGDATA g_sREGV_PixFmt_YUV422P    = REGDATA(PXL_FMT_YUV422_8,     (char*)"YUV422Packed");
    ...
    //      g_sREGV_PixFmt_BGR8,
        ...
        const REGDATA g_sREGV_PixSizeBG_BPP8    = REGDATA(RV_PIXSIZE_BG_BPP8,   (char*)"Bpp8");
        const REGDATA g_sREGV_PixSizeBG_BPP10   = REGDATA(RV_PIXSIZE_BG_BPP10,  (char*)"Bpp10");
        const REGDATA g_sREGV_PixSizeBG_BPP12   = REGDATA(RV_PIXSIZE_BG_BPP12,  (char*)"Bpp12");
        const REGDATA g_sREGV_PixSizeBG_BPP16   = REGDATA(RV_PIXSIZE_BG_BPP16,  (char*)"Bpp16");
        const REGDATA g_sREGV_PixSizeBG_BPP24   = REGDATA(RV_PIXSIZE_BG_BPP24,  (char*)"Bpp24");
        ...
        const REGDATA g_sREGV_TstImg_Off        = REGDATA( RV_TSTIMG_OFF,           (char*)"Off");
        const REGDATA g_sREGV_TstImg_Black      = REGDATA( RV_TSTIMG_BLACK,         (char*)"Black");
        const REGDATA g_sREGV_TstImg_White      = REGDATA( RV_TSTIMG_WHITE,         (char*)"White");
        const REGDATA g_sREGV_TstImg_RAMP       = REGDATA( RV_TSTIMG_GREY_H_RAMP,   (char*)"GreyHorizontalRamp");
        const REGDATA g_sREGV_TstImg_Grey_B     = REGDATA( RV_TSTIMG_BRIGHT_GREY,   (char*)"BrightGrey");
        const REGDATA g_sREGV_TstImg_Grey_D     = REGDATA( RV_TSTIMG_DARK_GREY,     (char*)"DarkGrey");
        ...
        const REGDATA g_sREGV_AcqMd_Single  = REGDATA( RV_ACQMD_SINGLE,     (char*)"SingleFrame");
        const REGDATA g_sREGV_AcqMd_Multi   = REGDATA( RV_ACQMD_MULTI,      (char*)"MultiFrame");
        const REGDATA g_sREGV_AcqMd_Cont    = REGDATA( RV_ACQMD_CONTINUOUS, (char*)"Continuous");
        ...
        const REGDATA g_sREGV_Off   = REGDATA( RV_ONOFF_OFF,    (char*)"Off");
        const REGDATA g_sREGV_On    = REGDATA(RV_ONOFF_ON,      (char*)"On");
        ...
        const REGDATA g_sREGV_TrgSrc_Soft   = REGDATA( RV_TRGSRC_SOFT,  (char*)"Software");
        const REGDATA g_sREGV_TrgSrc_Line0  = REGDATA( RV_TRGSRC_LINE0, (char*)"Line0");
        ...
        const REGDATA g_sREGV_TrgAct_RiseE  = REGDATA( RV_TRGACT_RISING_EDGE,   (char*)"RisingEdge");
        const REGDATA g_sREGV_TrgAct_FallE  = REGDATA( RV_TRGACT_FALLING_EDGE,  (char*)"FallingEdge");
        const REGDATA g_sREGV_TrgAct_AnyE   = REGDATA( RV_TRGACT_ANY_EDGE,      (char*)"AnyEdge");
        const REGDATA g_sREGV_TrgAct_LvlH   = REGDATA( RV_TRGACT_LEVEL_HIGH,    (char*)"LevelHigh");
        const REGDATA g_sREGV_TrgAct_LvlL   = REGDATA( RV_TRGACT_LEVEL_LOW,     (char*)"LevelLow");
        ...
        //const REGDATA g_sREGV_TrgOvl_Off  = REGDATA( RV_TRGOVL_OFF,           (char*)"Off");
        //const REGDATA g_sREGV_TrgOvl_ROut = REGDATA( RV_TRGOVL_READOUT,       (char*)"ReadOut");
        //const REGDATA g_sREGV_TrgOvl_PrevF    = REGDATA( RV_TRGOVL_PREV_FRAME,    (char*)"PreviousFrame");
        ...
        const REGDATA g_sREGV_ExpMd_Off             = REGDATA( RV_EXPMD_OFF,            (char*)"Off");
        const REGDATA g_sREGV_ExpMd_Timed           = REGDATA( RV_EXPMD_TIMED,          (char*)"Timed");
        const REGDATA g_sREGV_ExpMd_TriggerWidth    = REGDATA( RV_EXPMD_TRIGGERWIDTH,   (char*)"TriggerWidth");
        const REGDATA g_sREGV_ExpMd_TriggerControl  = REGDATA( RV_EXPMD_TRIGGERCONTROL, (char*)"TriggerControl");
        ...
        const REGDATA g_sREGV_Auto_Off  = REGDATA( RV_AUTO_OFF,         (char*)"Off");
        const REGDATA g_sREGV_Auto_Once = REGDATA( RV_AUTO_ONCE,        (char*)"Once");
        const REGDATA g_sREGV_Auto_Cont = REGDATA( RV_AUTO_CONTINUOUS,  (char*)"Continuous");
        ...
        const REGDATA g_sREGV_IOInv_ActL    = REGDATA( RV_IOINV_ACTIVE_L,       (char*)"ActiveLow");
        const REGDATA g_sREGV_IOInv_ActH    = REGDATA( RV_IOINV_ACTIVE_H,       (char*)"ActiveHigh");
        ...
        //================================================================
        const REGDATA g_sREGV_LineSrc_Off                       = REGDATA(  0, (char*)"Off");
        const REGDATA g_sREGV_LineSrc_AcquisitionTriggerWait    = REGDATA(  1, (char*)"AcquisitionTriggerWait");
        const REGDATA g_sREGV_LineSrc_AcquisitionActive         = REGDATA(  2, (char*)"AcquisitionActive");
        const REGDATA g_sREGV_LineSrc_FrameTriggerWait          = REGDATA(  3, (char*)"FrameTriggerWait");
        const REGDATA g_sREGV_LineSrc_FrameActive               = REGDATA(  4, (char*)"FrameActive");
        const REGDATA g_sREGV_LineSrc_ExposureActive            = REGDATA(  5, (char*)"ExposureActive");
        const REGDATA g_sREGV_LineSrc_Stream0TransferActive     = REGDATA(  6, (char*)"Stream0TransferActive");
        const REGDATA g_sREGV_LineSrc_Stream1TransferActive     = REGDATA(  7, (char*)"Stream1TransferActive");
        const REGDATA g_sREGV_LineSrc_Stream0TransferPaused     = REGDATA(  9, (char*)"Stream0TransferPaused");
        const REGDATA g_sREGV_LineSrc_Stream1TransferPaused     = REGDATA( 10, (char*)"Stream1TransferPaused");
        const REGDATA g_sREGV_LineSrc_Stream0TransferStopping   = REGDATA( 12, (char*)"Stream0TransferStopping");
        const REGDATA g_sREGV_LineSrc_Stream1TransferStopping   = REGDATA( 13, (char*)"Stream1TransferStopping");
        const REGDATA g_sREGV_LineSrc_Stream0TransferStopped    = REGDATA( 15, (char*)"Stream0TransferStopped");
        const REGDATA g_sREGV_LineSrc_Stream1TransferStopped    = REGDATA( 16, (char*)"Stream1TransferStopped");
        const REGDATA g_sREGV_LineSrc_Stream0TransferOverflow   = REGDATA( 18, (char*)"Stream0TransferOverflow");
        const REGDATA g_sREGV_LineSrc_Stream1TransferOverflow   = REGDATA( 19, (char*)"Stream1TransferOverflow");
        const REGDATA g_sREGV_LineSrc_Counter0Active            = REGDATA( 21, (char*)"Counter0Active");
        const REGDATA g_sREGV_LineSrc_Counter1Active            = REGDATA( 22, (char*)"Counter1Active");
        const REGDATA g_sREGV_LineSrc_Counter2Active            = REGDATA( 23, (char*)"Counter2Active");
        const REGDATA g_sREGV_LineSrc_Timer0Active              = REGDATA( 25, (char*)"Timer0Active");
        const REGDATA g_sREGV_LineSrc_Timer1Active              = REGDATA( 26, (char*)"Timer1Active");
        const REGDATA g_sREGV_LineSrc_Timer2Active              = REGDATA( 27, (char*)"Timer2Active");
        const REGDATA g_sREGV_LineSrc_TUserOutput0              = REGDATA( 29, (char*)"UserOutput0");
        const REGDATA g_sREGV_LineSrc_TUserOutput1              = REGDATA( 30, (char*)"UserOutput1");
        const REGDATA g_sREGV_LineSrc_TUserOutput2              = REGDATA( 31, (char*)"UserOutput2");

        const REGDATA g_sREGV_LineSrc_VD                        = REGDATA( 32, (char*)"VD");
        const REGDATA g_sREGV_LineSrc_FrameTransfer             = REGDATA( 33, (char*)"FrameTransfer");
        ...
        const REGDATA g_sREGV_Evnt_Frm_Trg          = REGDATA(RV_EVNT_FRM_TRG,              (char*)"FrameTrigger");
        const REGDATA g_sREGV_Evnt_ALC_Latest       = REGDATA(RV_EVNT_ALC_LATEST,           (char*)"ALCLatestInformation");
        const REGDATA g_sREGV_Evnt_ALC_Converged    = REGDATA(RV_EVNT_ALC_CONVERGED,        (char*)"ALCConverged");
        const REGDATA g_sREGV_Evnt_Dev_OverHeat     = REGDATA(RV_EVNT_DEV_OVERHEAT, (char*)"DeviceOverHeated");
        ...
        const REGDATA g_sREGV_TmrTrgSrc_Off         = REGDATA(RV_TMR_TRGSRC_OFF,        (char*)"Off");
        const REGDATA g_sREGV_TmrTrgSrc_Acq_Trg     = REGDATA(RV_TMR_TRGSRC_ACQ_TRG,    (char*)"AcquisitionTrigger");
        const REGDATA g_sREGV_TmrTrgSrc_Acq_Str     = REGDATA(RV_TMR_TRGSRC_ACQ_STR,    (char*)"AcquisitionStart");
        const REGDATA g_sREGV_TmrTrgSrc_Acq_End     = REGDATA(RV_TMR_TRGSRC_ACQ_END,    (char*)"AcquisitionEnd");
        const REGDATA g_sREGV_TmrTrgSrc_Frm_Trg     = REGDATA(RV_TMR_TRGSRC_FRM_TRG,    (char*)"FrameTrigger");
        const REGDATA g_sREGV_TmrTrgSrc_Frm_Str     = REGDATA(RV_TMR_TRGSRC_FRM_STR,    (char*)"FrameStart");
        const REGDATA g_sREGV_TmrTrgSrc_Frm_End     = REGDATA(RV_TMR_TRGSRC_FRM_END,    (char*)"FrameEnd");
        const REGDATA g_sREGV_TmrTrgSrc_Lin_Str     = REGDATA(RV_TMR_TRGSRC_LIN_STR,    (char*)"LineStart");
        const REGDATA g_sREGV_TmrTrgSrc_Lin_End     = REGDATA(RV_TMR_TRGSRC_LIN_END,    (char*)"LineEnd");
        const REGDATA g_sREGV_TmrTrgSrc_Exp_Str     = REGDATA(RV_TMR_TRGSRC_EXP_STR,    (char*)"ExposureStart");
        ...
        const REGDATA g_sREGV_Usrset_Default    = REGDATA(RV_USRSET_SEL_DEFAULT,    (char*)"Default");
        const REGDATA g_sREGV_Usrset_1          = REGDATA(RV_USRSET_SEL_1,          (char*)"Userset1");
        const REGDATA g_sREGV_Usrset_2          = REGDATA(RV_USRSET_SEL_2,          (char*)"Userset2");
        const REGDATA g_sREGV_Usrset_3          = REGDATA(RV_USRSET_SEL_3,          (char*)"Userset3");
        const REGDATA g_sREGV_Usrset_SafeMode   = REGDATA(RV_USRSET_SEL_SAFE_MODE,  (char*)"SafeMode");
        ...
        const REGDATA g_sREGV_ALC_AreaFull      = REGDATA(RV_ALC_AREA_SIZE_FULL,    (char*)"Full");
        const REGDATA g_sREGV_ALC_AreaMedium    = REGDATA(RV_ALC_AREA_SIZE_MEDIUM,  (char*)"Medium");
        const REGDATA g_sREGV_ALC_AreaSmall     = REGDATA(RV_ALC_AREA_SIZE_SMALL,   (char*)"Small");
